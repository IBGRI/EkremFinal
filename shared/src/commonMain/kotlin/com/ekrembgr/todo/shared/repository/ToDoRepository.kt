package com.ekrembgr.todo.shared.repository
...
class ToDoRepository(
    ...
    suspend fun ekle(content: String) = withContext(scope.coroutineContext) {
        database.toDoQueries.insertToDo(content)
    }

    suspend fun sil(toDo: ToDo) = withContext(scope.coroutineContext) {
